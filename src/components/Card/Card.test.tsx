...
test("renders Character name - Luna", () => {
  render(
    <MemoryRouter>
      <Card
        id={3}
        img={"https://images92.fotosik.pl/634/ba88b64387a4d385med.jpg"}
        characterName={"Luna"}
        information={"info character"}
        game={"xxx"}
        death={true}
      />
    </MemoryRouter>
...
it("renders  image Character Luna", () => {
  ...
  expect(image).toHaveAttribute(
    "src",
    "https://images92.fotosik.pl/634/ba88b64387a4d385med.jpg"
  );
});
...
it("renders image when not img character", () => {
  ...
  expect(image).toHaveAttribute(
    "src",
    "https://ogrod.ukw.edu.pl/img/no-image-person.png"
  );
});
